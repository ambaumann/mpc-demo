...
public abstract class AbstractXlsxSolutionFileIO<Solution_> implements SolutionFileIO<Solution_> {
    ...
    protected static final XSSFColor VIEW_TAB_COLOR = new XSSFColor(BUTTER_1);
    protected static final XSSFColor UNAVAILABLE_COLOR = new XSSFColor(ALUMINIUM_5);
    protected static final XSSFColor PINNED_COLOR = new XSSFColor(PLUM_1);
    protected static final XSSFColor HARD_PENALTY_COLOR = new XSSFColor(SCARLET_1);
    protected static final XSSFColor MEDIUM_PENALTY_COLOR = new XSSFColor(SCARLET_3);
    protected static final XSSFColor SOFT_PENALTY_COLOR = new XSSFColor(ORANGE_1);
    ...
    public static abstract class AbstractXlsxWriter<Solution_> {
        ...
        public AbstractXlsxWriter(Solution_ solution, String solverConfigResource) {
            ...
            try (ScoreDirector<Solution_> scoreDirector = scoreDirectorFactory.buildScoreDirector()) {
                ...
                //TODO might have messed up scoring. Might be due to using different version of optaplanner.
